...
W poni¿szym rozdziale zosta³ zawarty opis oraz analiza modelu matematycznego skrzyd³a podlegaj¹cego zjawisku flatteru.

\section{Model matematyczny}
(TODO wyjaœniæ dlaczego stosujemy profil referencyjny, jego po³o¿enie wzd³u¿ skrzyd³a)

Model matematyczny elastycznego skrzyd³a o dwóch stopniach swobody zosta³ zaczerpniêty z \cite{WaszakModel}. Na model sk³ada siê dynamika strukturalna, aerodynamika quasi-stacjonarna, dynamika elementu wykonawczego oraz prosty model turbulencji.
...
Model aerodynamiki oparty na wspó³czynnikach jest raczej uproszczonym podejœciem, ale w zupe³noœci wystarczaj¹cy aby uchwyciæ najwa¿niejsze cechy zjawiska flutteru~\cite{WaszakModel}.
...
\section{Modelu skrzyd³a z niepewnoœci¹}
